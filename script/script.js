...
function tempChart(hours, tempCelcius) {
  ...
  document.querySelector("#tempratur").innerHTML = "Grafik tempratur (C)";
}
...
function humadityChart(hours, humidity) {
  ...
  document.querySelector("#humadity").innerHTML = "Grafik Kelembapan (%)";
}
...
function windChart(hours, wind) {
  ...
  document.querySelector("#wind").innerHTML = "Grafik Kecepatan Angin (Km/h)";
}
...
function pressureChart(hours, pressure) {
  ...
  document.querySelector("#pressure").innerHTML = "Grafik Tekanan (Milibar)";
}
